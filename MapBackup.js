...
const [open, setOpen] = useState(false);
  ...
  const [errorMsg, setErrorMsg] = useState(null);
    ...
    if (!fontsLoaded) {
      ...
      const locationPosition = new Animated.ValueXY({x:70,y:0})
      Animated.timing(locationPosition,{
        toValue:{x:-10,y:0},
        useNativeDriver: true,
      }).start()
  ...
  return (
    ...
    <View style={styles.container}>
     ...
     {!showNext &&
          <>
           <Animated.View style={{backgroundColor:'black',position:'absolute',borderRadius:50,
      padding:7,top:400,alignSelf:'flex-end',right:20,transform:[{translateX:locationPosition.x} ]}}>
      ...
      source={require('../assets/images/findLocation.png')}/>
           ...
           <Animated.View style={[styles.box,{alignItems: 'center', transform:[{translateY:position.y}  ]}]}>
  
          <View >
         
            
          <TextInput style={[styles.inputstyle,{marginTop:25}]}
          ...
          <Image style={{width:24,height:24,position:'absolute',marginTop:38,alignSelf:'flex-end',right:10,}}
          ...
          <>
          <Animated.View style={{backgroundColor:'black',position:'absolute',borderRadius:50,
      padding:7,top:340,alignSelf:'flex-end',right:20,transform:[{translateX:locationPosition.x} ]}}>
          <TouchableOpacity style={{}}
                  onPress={userLocation}>
      <Image style={{width:32,height:32}}
      source={require('../assets/images/findLocation.png')}/>
          ...
          <Animated.View style={[styles.box2,{alignItems: 'center', transform:[{translateY:position.y} ]}]}>
          ...
          <Text style={{color:'white',fontSize:18,fontFamily:'Poppins-Medium'}}>Choose a ride</Text>
            ...
            <View >
            <TouchableOpacity style={styles.vehicleBorder}>
          ...
          <Animated.View style={{backgroundColor:'black',borderRadius:50,
      width:38,height:38,alignSelf:'flex-start',marginTop:15,marginLeft:10,justifyContent:'center',
      position:'absolute',transform:[{translateX:backPosition.x}  ]}}>
        <TouchableOpacity 
